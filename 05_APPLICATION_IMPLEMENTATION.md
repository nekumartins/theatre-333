...
- **Features**: Interactive seat map, real-time validation, QR code generation
...
## 2. Project Structure (Actual Implementation)
...
│   │       ├── shows.py            # Shows API
│   │       ├── performances.py     # Performances & seats API
...
│   │   ├── show_detail.html        # Show details + performances
│   │   ├── seat_selection.html     # Interactive seat map (491 seats)
...
│   ├── index.html                  # HTML slides
│   ├── Theatre_Booking_System.pptx # PowerPoint
│   └── erd_diagram.svg             # ERD diagram
│
...
## 3. Database Connection (Implemented)
...
.\data333\Scripts\Activate.ps1   # Windows
...
<body class="bg-gray-50">
    ...
    <nav class="bg-indigo-600 text-white p-4">
        <div class="container mx-auto flex justify-between items-center">
            <a href="/" class="text-2xl font-bold">🎭 Theatre Booking</a>
            <div class="space-x-4">
